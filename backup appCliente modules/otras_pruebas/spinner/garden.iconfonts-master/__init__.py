...
#Instalacion de iconfonts -->
# $ sudo pip install kivy-garden

#Instalacion del paquete iconfonts de kivy -->
# $ garden install iconfonts
#
#Download done (16977 downloaded)
#Extracting...
#Installing new version...
#Done! garden.iconfonts is installed at: /home/rodrigo/.kivy/garden/garden.iconfonts
#Cleaning...
...
BoxLayout:
    ...
    Button:
        markup: True
        text: "%s Text"%(icon('icon-plus-circled', 24,'ff3333'))
    ...
    Label:
        id: _anim
        markup: True
        text: "%s"%(icon('icon-spin6', 32,'ff3333'))
        font_color: 1, 0, 0, 1
        p: 0
        canvas:
            Clear

...
class XTextInput(XForm):
    ...
    def _get_form(self):
        ...
        #Limpieza del textinput agregada!
        text_input.bind(on_touch_down = self.clearTxt)
        layout.add_widget(Widget())
        layout.add_widget(text_input)
        layout.add_widget(Widget())
        return layout

    def clearTxt(self,instance,evt):
        print "tipo instance: %s; tipo evt: %s\n" % (type(instance),type(evt))
        instance.text = ''
        print "limpiado txtinput!\n"

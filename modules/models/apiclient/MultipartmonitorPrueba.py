...
def create_callback(encoder):
    ...
    def callback(monitor):
        ...
        print "Monitor.finished? %s" % monitor.encoder.finished
        print ""
    return callback
...
def create_upload():
    return MultipartEncoder({
        ...
        'first_file': ('MultipartmonitorPrueba.py', open(__file__, 'rb'), 'text/plain'),
        'second_file': ('MultipartmonitorPrueba.py', open(__file__, 'rb'),
                        'text/plain'),
        })
